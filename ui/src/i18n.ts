...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "models.title": "Models",
    "models.desc": "Edit model configuration and bundle YAML.",
    "models.refresh": "Refresh",
    "models.new": "New",
    "models.save": "Save",
    "models.export": "Export",
    "models.import": "Import",
    "models.mode.form": "Form",
    "models.mode.yaml": "YAML",
    "models.delete": "Delete",
    "models.list": "Available Models",
    "models.catalog.section": "Catalog",
    "models.catalog.desc": "Defaults for all models. Edit aliases and templates in YAML mode.",
    ...
    "models.catalog.note": "Aliases, templates, and advanced fields are editable in YAML mode.",
    "models.raw.title": "Raw Models Bundle",
    "models.raw.hint": "Editing YAML replaces the whole bundle.",
    "models.kind": "Kind",
  ...
  zh: {
    ...
    "models.catalog.desc": "统一默认值设置；别名与模板请在 YAML 模式中编辑。",
    ...
    "models.catalog.note": "别名、模板与高级字段请在 YAML 模式中编辑。",
    "models.raw.title": "模型打包 YAML",
    "models.raw.hint": "编辑 YAML 会整体替换模型配置。",
    "models.kind": "类型",
