...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "models.title": "Models",
    "models.desc": "Edit model definitions in YAML with strict validation.",
    ...
    "models.editor.section": "Model YAML",
    "models.validation.title": "Validation",
    "models.validation.ok": "No errors.",
    "models.validation.blocked": "Fix errors before saving.",
    ...
    "error.model.validation": "Fix validation errors before saving",
    "error.model.empty": "Model YAML is empty",
    "error.model.yaml": "Invalid YAML",
    "error.catalog.validation": "Fix catalog validation errors before saving",
    "error.catalog.empty": "Catalog YAML is empty",
    "error.catalog.yaml": "Invalid catalog YAML",
    ...
    "access.badge": "LLM Site",
    "access.title": "LLM API",
    "access.subtitle": "Use /v1",
    "access.lead": "LLM API site. Call via /v1.",
    "access.p1": "",
    "access.p2": "",
    "access.p3": "",
    "access.p4": "",
    "access.p5": "",
    "access.p6": "",
    "access.key.title": "Key Status",
    "access.key.enabled": "Key required: {key}",
    "access.key.disabled": "No key required.",
    "access.key.loading": "Loading...",
    "access.key.error": "Failed to load backend settings.",
    "access.footer": ""
  },
  zh: {
    "app.title": "管理控制台",
    ...
    "models.title": "模型",
    "models.desc": "用 YAML 编辑模型配置（严格校验）",
    "models.refresh": "刷新",
    "models.new": "新建",
    "models.save": "保存",
    "models.format": "格式化",
    ...
    "models.delete": "删除",
    "models.list": "模型列表",
    "models.editor.section": "模型 YAML",
    "models.validation.title": "校验",
    "models.validation.ok": "没有发现错误。",
    "models.validation.blocked": "修正错误后才能保存。",
    ...
    "error.model.validation": "请先修正校验错误",
    "error.model.empty": "模型 YAML 不能为空",
    "error.model.yaml": "YAML 解析失败",
    "error.catalog.validation": "请先修正目录配置的校验错误",
    "error.catalog.empty": "目录 YAML 不能为空",
    "error.catalog.yaml": "目录 YAML 解析失败",
    "error.export": "导出失败",
    "error.import": "导入失败",
    ...
    "access.badge": "LLM 站点",
    "access.title": "LLM API",
    "access.subtitle": "使用 /v1 调用",
    "access.lead": "这是一个 LLM API 站点，调用路径为 /v1。",
    "access.p1": "",
    "access.p2": "",
    "access.p3": "",
    "access.p4": "",
    "access.p5": "",
    "access.p6": "",
    "access.key.title": "密钥状态",
    "access.key.enabled": "需要密钥：{key}",
    "access.key.disabled": "无需密钥。",
    "access.key.loading": "读取中...",
    "access.key.error": "读取失败，请稍后重试。",
    "access.footer": ""
